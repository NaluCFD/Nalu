...
// Class Definition
//==========================================================================
// MomentumAdvDiffElemSuppAlgDep - NSO for momentum equation
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
MomentumAdvDiffElemSuppAlgDep::MomentumAdvDiffElemSuppAlgDep(
  Realm &realm,
...
//--------------------------------------------------------------------------
void
MomentumAdvDiffElemSuppAlgDep::elem_resize(
  MasterElement *meSCS,
  MasterElement */*meSCV*/)
{
...
//--------------------------------------------------------------------------
void
MomentumAdvDiffElemSuppAlgDep::setup()
{
  // nothing to extract
}
...
//--------------------------------------------------------------------------
void
MomentumAdvDiffElemSuppAlgDep::elem_execute(
  double *lhs,
  double *rhs,
