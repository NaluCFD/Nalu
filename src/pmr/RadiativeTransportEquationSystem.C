  ...
  stk::mesh::Part *part)
{
  ...
  nalu::mesh::put_field(*intensity_, *part);
  ...
  nalu::mesh::put_field(*absorptionCoeff_, *part);
  ...
  nalu::mesh::put_field(*scatteringCoeff_, *part);
