...
realms:
  ...
  - name: realm_1
    ...
    solution_options:
      ...
      options:
        ...
        - element_source_terms:
            momentum: [momentum_time_derivative, advection_diffusion, SteadyTaylorVortex]
    ...
    output:
      output_data_base_name: hoVortex_P2_R2.e
      output_frequency: 10
      output_node_set: no 
      output_variables:
       - dual_nodal_volume
