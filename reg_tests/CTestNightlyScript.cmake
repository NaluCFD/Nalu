...
## -- Configure Command
if(${COMPILER_NAME} MATCHES "intel")
  set(EXTRA_ARGS "-DCMAKE_CXX_FLAGS=-restrict")
endif()

set(CTEST_CONFIGURE_COMMAND "cmake -DTrilinos_DIR:PATH=${TRILINOS_DIR} -DYAML_DIR:PATH=${YAML_DIR} -DENABLE_INSTALL:BOOL=OFF -DCMAKE_BUILD_TYPE=RELEASE -DENABLE_TESTS=ON -DNALURTEST_DIR:PATH=${NALURTEST_DIR} -DRUNNALURTEST_DIR:PATH=${RUNNALURTEST_DIR} ${CTEST_SOURCE_DIRECTORY} ${EXTRA_ARGS}")
