...
#ifndef MomentumNSOSijElemSuppAlg_h
#define MomentumNSOSijElemSuppAlg_h
...
class MomentumNSOSijElemSuppAlg : public SupplementalAlgorithm
{
public:

  MomentumNSOSijElemSuppAlg(
    Realm &realm,
    VectorFieldType *velocity,
    ElemDataRequests& dataPreReqs);

  virtual ~MomentumNSOSijElemSuppAlg() {}
  ...
  // constants that prevail over simulation
  const double Cupw_;
  const double small_;
