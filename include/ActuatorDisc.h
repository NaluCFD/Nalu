...
#ifndef ActuatorDisc_h
#define ActuatorDisc_h
...
class ActuatorDiscPointInfo {
 public:
  ActuatorDiscPointInfo(
 ...
 class ActuatorDisc: public Actuator
{
public:
  ...
  void create_actuator_disc_point_info_map();
  ...
  // custom ghosting
  stk::mesh::Ghosting *actuatorDiscGhosting_;
  ...
  std::vector<ActuatorDiscInfo *> actuatorDiscInfo_; 

  // map of point info objects
  std::map<size_t, ActuatorDiscPointInfo *> actuatorDiscPointInfoMap_;
